...
public class roomInfo {
    ...
    public class Room implements displayInfo{
...
// Here is the subclasses that represent all of the different types of rooms
    ...
    public class CombatRoom extends Room implements displayInfo {
    ...
    public class PuzzleRoom extends Room implements displayInfo{
    ...
    public class EntranceRoom extends Room implements displayInfo{
